...
If your organization has users committing to Github repositories linked to Sentry that are not members of your organization, Sentry will remind organization owners and managers to invite these users through a banner on the members list page.

![Github missing members invite banner](github-missing-members-banner.png)

The banner will show the 5 most active contributors. To see all of the missing members (up to 50), click **View All** on the banner. To snooze the banner, click the ellipsis > **Hide Missing Members**.

// TODO: modal image

You can select multiple users and assign roles and teams before inviting them through the modal.
